            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text(
                    FormatService.formatDate(date, format: 'dd/MM/yyyy HH:mm'),
                    style: const pw.TextStyle(fontSize: 8),
                  ),
                ],
              ),
              ...
              ...items.map((item) {
                ...
                final total =
                    (item['total'] as num?)?.toDouble() ?? (qty * price);
              ...
              _buildPdfSummaryRow(
                'Subtotal:',
                FormatService.formatCurrency(subtotal, symbol: currencySymbol),
              ),
              if (discount > 0)
                _buildPdfSummaryRow(
                  'Discount:',
                  '-${FormatService.formatCurrency(discount, symbol: currencySymbol)}',
                ),
              if (tax > 0)
                _buildPdfSummaryRow(
                  'Tax:',
                  FormatService.formatCurrency(tax, symbol: currencySymbol),
                ),
